...
class Node<T> {
  ...
  static Node<T> fromMap<T>(Map<String, dynamic> map) {
    ...
    return Node<T>(
      ...
      secondFloor: Utilities.truthful(map['secondFloor']),
      thirdFloor: Utilities.truthful(map['thirdFloor']),
      children: _children,
    );
  }
  ...
  Node<T> copyWith({
    ...
    T data,
      ...
      Node<T>(
        ...
        secondFloor: secondFloor ?? this.secondFloor,
        thirdFloor: thirdFloor ?? this.thirdFloor,
  ...
  bool get isMiddle => secondFloor;

  bool get isThird => thirdFloor;
  ...
  bool operator ==(Object other) {
    ...
    return other is Node &&
        ...
        other.parent == parent &&
        other.secondFloor == secondFloor &&
        other.thirdFloor == thirdFloor &&
